    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": { 
            boxShadow: "0 0 60px hsl(var(--primary)), 0 0 100px hsl(var(--secondary)), 0 0 140px hsl(var(--primary))",
        ...
        "text-glow": {
          ...
          "50%": { 
            textShadow: "0 0 40px hsl(var(--primary)), 0 0 80px hsl(var(--secondary)), 0 0 120px hsl(var(--primary))",
      ...
      animation: {
        ...
        "glitchSweep": "glitchSweep 500ms ease-in-out infinite",
